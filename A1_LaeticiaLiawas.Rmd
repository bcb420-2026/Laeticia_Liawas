...
output:
  bookdown::html_document2:
    ...
    toc_depth: 3                
    toc_float: true             
bibliography: bcb420-assignment1/references.bib
...
From the heatmap we can see that the samples cluster by disease condition, as expected. We can also see from the heatmap why they would cluster--in DHF patients, SEC13 is downregulated, while IGHG1 and PTEN are upregulated, and vice versa for DF patients.
